"""
Seed the single-column UNION lab.

Administrator password is a random 16-byte token so the only way to
obtain it is via the intended concat-in-one-column UNION extraction.
...
FLAG_CONTENT = "FLAG{psw-sqli-10-union-concat-admin-access}"
